...
\begin{description}
    ...
    \begin{align*}\allowdisplaybreaks
        ...
        \implies 0&\begin{aligned}[t]
            ...
            \end{aligned}
        \end{aligned}\\
        \explain{\text{\( Y_{\ell}^k \) linearly independent}}{\implies} 0&=Y^m_{\ell}\quad \text{or}\quad \tilde{u}_{i,\ell}^k\cdot (m/2)^\ell\cdot (1+2\ell)-\tilde{u}^k_{i,-\ell-1}\cdot (m/2)^{-\ell-1}(1+2\ell).
    \end{align*}
